        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {SERVICES.map((service, index) => (
            ...
            >
               ...
               <Link href="#contact" suppressHydrationWarning className="flex w-fit items-center gap-2 text-sm font-bold uppercase tracking-wider text-accent hover:opacity-80 transition-opacity mt-auto">
